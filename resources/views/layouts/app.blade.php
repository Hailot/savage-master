                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    @else
                        ...
                        <li class="nav-item dropdown">
                            <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                {{ 'Creatures'}} <span class="caret"></span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('creature.index') }}">{{ __('Browse Creatures') }}</a>
                                <a class="dropdown-item" href="{{ route('creature.create') }}">{{ __('Create Creature') }}</a>
                            ...
                            <div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">
                                ...
                                @if (Route::has('upload-image'))
                                    <a class="dropdown-item"
                                       href="{{ route('upload-image') }}">{{ __('Upload Image') }}</a>
                                @endif
                            </div>
                        </li>
                    @endguest
                <!-- Authentication Links -->
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('user-files') }}">{{ __('Files') }}</a>
